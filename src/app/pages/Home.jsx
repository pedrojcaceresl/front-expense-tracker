...
export const Home = () => {
	...
	return (
		<div className=" min-h-screen flex flex-col bg-radial to-blue-50 from-indigo-50">
			{/* Contenido Principal */}
			<div className='flex-grow mb-5'>
				...
				<div className="">
					{features.map((index) => (
						<div
							key={index.title}
							className=" flex justify-start items-start gap-10 mt-10 flex-wrap ml-4"
						>
							<div className=" flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-lg w-200 z-10">
				...
				{/* Imagen al lado */}
				<div className=" absolute right-10 top-150 transform -translate-y-1/2 z-10 hidden md:block ">
					<img
						src="gastosPh.png"
						alt="Gestor de gastos APP"
