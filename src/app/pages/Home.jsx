    ...
    return (
        <div className=' min-h-screen mt-2'>
            ...
            <div className=''>
                {
                    features.map((index) => (
                        <div className='flex justify-center items-center gap-12 px-8 mt-12 flex-wrap'>
                            <div key={index.title} className='flex flex-col items-center text-center bg-white p-6 rounded-lg shadow-lg w-200'>
            ...
            <div className=' mt-10 mb-5 flex flex-col items-center justify-end'>
                <footer className='bg-white text-center w-60 h-10'>
